...
using static SharpPipe.Commands.FUNC<string>;
...
*/
        ...
        public static class STRING {
            ...
            public static PipeFunc<string, int> Length => New( str => str.Length );

            public static ToEnumFunc<string, char> ToCharArray() => ToEnum( str => str.ToCharArray() );
            public static ToEnumFunc<string, char> ToCharArray( int startIndex, int length ) => ToEnum( str => str.ToCharArray(startIndex, length) );

            public static ToEnumFunc<string, string> Split( params char[] separator ) => ToEnum( str => str.Split(separator) );
            public static ToEnumFunc<string, string> Split( char[] separator, int count ) => ToEnum( str => str.Split(separator, count) );
            public static ToEnumFunc<string, string> Split( char[] separator, StringSplitOptions options ) => ToEnum( str => str.Split(separator, options) );
            public static ToEnumFunc<string, string> Split( char[] separator, int count, StringSplitOptions options )
                                => ToEnum(str => str.Split(separator, count, options));
            
            public static ToEnumFunc<string, string> Split( string[] separator, StringSplitOptions options ) => ToEnum(str => str.Split(separator, options));
            
            public static ToEnumFunc<string, string> Split( string[] separator, int count, StringSplitOptions options )
                                                    => ToEnum(str => str.Split(separator, count, options));
            ...
            public static FromEnumFunc<string, string> Join( [NotNull] string separator ) => FromEnum(e => string.Join(separator, e));
            public static FromEnumFunc<string, string> Concat => FromEnum(string.Concat);
        }
    }
}